...
//                  1 3
//
// This program compares a pair of trees by walking each in its own goroutine,
// sending their contents to a third goroutine that compares them.
...
// Walker launches Walk in new goroutine, returns read-only channel of values.
...
// Compare reads values from two Walkers that run simultaneously, then returns
